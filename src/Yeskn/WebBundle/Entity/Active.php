 ...
 *
 * created at 2018-05-27 11:09:15
 *
 ...
 * @ORM\Entity(repositoryClass="Yeskn\WebBundle\Repository\ActiveRepository")
 */
class Active
{
    /**
     ...
     * @ORM\ManyToOne(targetEntity="Yeskn\WebBundle\Entity\User",inversedBy="actives")
     */
    private $user;
